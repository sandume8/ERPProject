package kr.happyjob.study.mainlogin.model;
...
public class MainUsrMnuModel {
	// 메뉴 ID
		...
		//자식 node List
		private List<MainChildUsrMnuModel> nodeList = new ArrayList<MainChildUsrMnuModel>();
		 ...
		 * @return the nodeList
		 */
		public List<MainChildUsrMnuModel> getNodeList() {
			return nodeList;
		}

		/**
		 * @param list the nodeList to set
		 */
		public void setNodeList(List<MainChildUsrMnuModel> list) {
			this.nodeList = list;
		}
}
